...
export const content = {
    ...
    body: (
        <div className="space-y-6 text-zinc-600">
            ...
            <p className="leading-relaxed mt-4">To exercise any of these rights, please contact us at arshverma.dev@gmail.com or use the data management tools in your Settings page.</p>
            ...
            <p className="leading-relaxed">Email: arshverma.dev@gmail.com</p>
        </div>
    )
};
